...
export const AGENT_DEFINITIONS: readonly AgentRecord[] = [
  {
    ...
    sortOrder: 0,
    parentId: null,
    // M5-08: was missing orion and all 5 Corporate Office agents — now
    // matches the live agent_registry row's children_ids exactly.
    childrenIds: ['nova', 'flow', 'atlas', 'luna', 'echo', 'orion', 'vertex', 'forge', 'sentinel', 'cortex', 'ledger'],
    priority: 0,
    tools: [],
    createdAt: '',
    updatedAt: '',
  ...
  // M5-08: vertex/forge/sentinel/cortex/ledger (the Corporate Office
  // agents, seeded by supabase/migrations/20260819160000) were missing
  // from this fallback array entirely — if loadAgents() ever falls back
  // here (DB unreachable/empty), these 5 agents would silently vanish
  // system-wide rather than degrading gracefully like every other agent
  // (Deep Integrity Audit, Section C). Values below mirror the live
  // agent_registry seed rows exactly, same as every other entry in this
  // file.
  {
    id: 'vertex',
    displayName: 'Vertex',
    ...
    level: 'manager',
    departmentId: 'corporate_strategy',
    description:
  ...
  },
  {
    ...
    level: 'manager',
    departmentId: 'corporate_intelligence',
    description:
  ...
  },
  {
    ...
    level: 'manager',
    departmentId: 'finance_resources',
    description:
